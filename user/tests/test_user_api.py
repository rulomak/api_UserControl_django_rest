...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@gmail.com', password='tppass')
    ...
    def test_create_token_no_user(self):
        ''' Prueba que no sea creado el token si no existe el usuario '''
        payload = {
            'email': 'test@gmail.com',
            'password': 'testpass123',
        }
    ...
    def test_create_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 'pepepe', 'password': ''})
        self.assertNotIn('token',res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)

    def test_retrieve_user_unauthorized(self):
        ''' prueba que la autenticacion sea requeriada para los usuarios '''
